...
internal sealed partial class BlueskyMigrationsForm
{
    private void BuildLayout()
    {
        Text            = "Twitter → Bluesky Migrations";
        ...
        _statusLabel = new Label
        {
            ...
            Text      = "Select a query and click Search.",
        };
    ...
    private Panel BuildToolbar()
    {
        ...
        _queryBox = new ComboBox
        {
            Top = 8, Left = 64, Width = 370, Height = 26,
            BackColor = DarkTheme.Input, ForeColor = DarkTheme.TextPrimary,
            FlatStyle = FlatStyle.Flat, Font = new Font("Segoe UI", 9f),
        };
        foreach (var q in PresetQueries) _queryBox.Items.Add(q);
        _queryBox.SelectedIndex = 0;
        ...
        {
            Text = "Search", Top = 8, Left = 442, Width = 80, Height = 26,
    ...
    private DataGridView BuildGrid()
    {
        ...
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "Author",  HeaderText = "Author",    Width = 140, SortMode = DataGridViewColumnSortMode.Automatic });
